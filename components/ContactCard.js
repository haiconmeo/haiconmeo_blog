...
const ContactCard = () => {
    ...
    return (
        <Box bg={colorMode === 'light' ? "gray.700" : "gray.900"} w="100%" p={4} color={colorMode === 'light' ? "#fff" : "#ccc"}>
            ...
            <HStack mt="4">
                <Button _hover={{ bg: colorMode === 'light' ? '#928DAB' : "green.100", color: colorMode === 'light' ? null : "#111"}} variant="outline" leftIcon={<FaFacebook/>}>
                    <a target="_blank" rel="noreferrer" href={contact.twitter}>Facebook</a>
                </Button>
